    ...
    <div className="min-h-screen bg-paper">
      ...
      {!ws.brandingRemoved && (
        <footer className="py-10 text-center">
          <a href="https://www.feedlark.com?ref=badge" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 rounded-full border border-sand-200 bg-white px-3 py-1.5 text-xs font-medium text-ink-muted shadow-sm transition-colors hover:text-ink">
