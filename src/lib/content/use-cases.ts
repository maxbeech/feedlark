...
export const USE_CASES: UseCase[] = [
  {
    ...
    intro: "Turn scattered feature requests from support, sales and Slack into one prioritised, public roadmap, then tell customers the moment you ship.",
    ...
    wins: ["One public board your whole user base can vote on", "A live roadmap that answers 'what's next' automatically", "Unlimited users free, so your growth never raises the bill"],
  },
  {
    slug: "indie-hackers",
    ...
    intro: "Ship in public, let users vote on what's next, and prove momentum with a changelog, all without paying enterprise prices on day one.",
