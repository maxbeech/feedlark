...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    description:
      "A clear breakdown of Canny's 2026 pricing, its 25-tracked-user free cap and per-user billing, plus how to dodge the growth tax with a free alternative.",
    date: "2026-06-18",
    ...
    blocks: [
      ...
      { h2: "Why this is a 'growth tax'", p: "The more your feedback board takes off, the more you pay, even though extra voters cost you nothing to serve. Plenty of teams describe it as being punished for engagement." },
      { h2: "How to avoid it", p: "Feedlark does the opposite. Unlimited end-users, posts and votes are free; you only pay per admin seat ($19/mo) if you want brand and team extras. Your 26th user is free, and so is your 26,000th." },
    ],
  },
  {
    ...
    description:
      "Compare 7 of the best Canny alternatives for 2026: Feedlark, Featurebase, Frill, Nolt, Productboard, Upvoty and Fider, by price, free plan and features.",
    date: "2026-06-17",
    keyword: "canny alternatives",
    readMins: 6,
    blocks: [
      { p: "If Canny's per-user pricing or 25-user free cap pushed you to look around, here are seven alternatives worth knowing, and how they differ on the thing that matters most: what you pay as you grow." },
      { h2: "The shortlist", ul: [
        ...
        "Nolt: beautifully designed, flat ~$29/mo per board; no API or AI.",
      ...
      { h2: "How to choose", p: "If you want a focused feedback board, public roadmap and changelog without paying more as more users engage, pick a tool that bills per admin seat (or is free) rather than per tracked user." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { h2: "Close the loop when you ship", p: "When something ships, move it to Shipped and tell the people who asked. Tools like Feedlark do this for you: a changelog entry goes out and every voter gets notified." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { h2: "Capture every request on one board", p: "Give users one public board to post ideas. Route requests from support and sales there too, so nothing is lost." },
  ...
  },
  {
    ...
    readMins: 4,
    blocks: [
      { p: "A changelog is free marketing and retention, as long as people actually read it. These practices keep yours useful." },
      ...
      { h2: "Link releases to requests", p: "When a release answers a feature request, link them. It shows users their feedback drives the product, and it's the heart of closing the feedback loop." },
